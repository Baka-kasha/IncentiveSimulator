...
public partial class BRAND3 : System.Web.UI.Page
{
    ...
    public void BindGrid()
    {
        ...
        if (sm == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT * FROM [EMPLOYEE_Incentive_Brand_3_TAB] where SM='" + Session["FSCODE"] + "' order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
        ...
        if (rbm == desgna || (rm == desgna && tea == "GT+MT") || (zbm == desgna && tea == "AX"))
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT * FROM [EMPLOYEE_Incentive_Brand_3_TAB] where RBM='" + Session["FSCODE"] + "' order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (dsm == desgna || asm == desgna || (rm == desgna && tea == "AX") || nkam == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT * FROM [EMPLOYEE_Incentive_Brand_3_TAB] where DSM='" + Session["FSCODE"] + "' order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (tbe == desgna || tbm == desgna || tso == desgna || kam == desgna || kae == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT * FROM [EMPLOYEE_Incentive_Brand_3_TAB] where FS_Code ='" + Session["FSCODE"] + "'order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (desgna == Admin)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT * FROM [EMPLOYEE_Incentive_Brand_3_TAB] order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
    ...
    private void ExportGridToExcel()
    {
        ...
        if (sm == desgna)
        {
            StrQrry = " SELECT  [DESIGNATION] ,[EMP_NAME],[CLIENT_HQ],[NOP_HQ],[TARGET_VAL] ,[PRIMARY_VAL] ,[ACH][ACH%],[AMOUNT] FROM [EMPLOYEE_Incentive_Brand_3_TAB] where SM ='" + Session["FSCODE"] + "' order by ROW_ID;";

        }
        if (rbm == desgna)
        {
            StrQrry = " SELECT  [DESIGNATION] ,[EMP_NAME],[CLIENT_HQ],[NOP_HQ],[TARGET_VAL] ,[PRIMARY_VAL] ,[ACH][ACH%],[AMOUNT] FROM [EMPLOYEE_Incentive_Brand_3_TAB] where RBM ='" + Session["FSCODE"] + "' order by ROW_ID;";

        }
        if (dsm == desgna)
        {
            StrQrry = " SELECT  [DESIGNATION] ,[EMP_NAME],[CLIENT_HQ],[NOP_HQ],[TARGET_VAL] ,[PRIMARY_VAL] ,[ACH][ACH%],[AMOUNT] FROM [EMPLOYEE_Incentive_Brand_3_TAB] where DSM ='" + Session["FSCODE"] + "' order by ROW_ID;";

        }
        if (tbe == desgna || tbm == desgna)
        {
            StrQrry = " SELECT  [DESIGNATION] ,[EMP_NAME],[CLIENT_HQ],[NOP_HQ],[TARGET_VAL] ,[PRIMARY_VAL] ,[ACH][ACH%],[AMOUNT] FROM [EMPLOYEE_Incentive_Brand_3_TAB] where FS_Code ='" + Session["FSCODE"] + "' order by ROW_ID;";

        }
        if (desgna == "Admin")
        {
            StrQrry = " SELECT  [DESIGNATION] ,[EMP_NAME],[CLIENT_HQ],[NOP_HQ],[TARGET_VAL] ,[PRIMARY_VAL] ,[ACH][ACH%],[AMOUNT] FROM [EMPLOYEE_Incentive_Brand_3_TAB] order by ROW_ID;";
        ...
        Response.Charset = "";
        string FileName = "BRAND 3" + Session["FSCODE"] + "_" + DateTime.Now + ".xls";
    ...
    protected void Organo_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("SELECT * FROM [dbo].['Brand Group 3$'] where DESIGNATION = '" + Designation + "' and TEAM = '" + TEAM + "' ;", conn);
                conn.Open();
                    ...
                    if (ACHIVEVEEMNT >= dataTableValue)
                    {
                        using (SqlConnection conn1 = new SqlConnection(con1n))
                        {
                            ...
                            if (logintbl1.Rows.Count == 0)
                            {
                                ...
                                SqlCommand cmmd = new SqlCommand("[EMPLOYEE_Incentive_Brand_3]", conn);
                                {
    ...
    protected void refersh_Click(object sender, EventArgs e)
    {
        ...
        if (sm == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT * FROM [EMPLOYEE_Incentive_Brand_3_TAB] where SM='" + Session["FSCODE"] + "' " + whreclase + " order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (rbm == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT * FROM [EMPLOYEE_Incentive_Brand_3_TAB] where RBM='" + Session["FSCODE"] + "' " + whreclase + " order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (dsm == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT * FROM [EMPLOYEE_Incentive_Brand_3_TAB] where DSM='" + Session["FSCODE"] + "' " + whreclase + " order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (desgna == "Admin")
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT * FROM [EMPLOYEE_Incentive_Brand_3_TAB] where " + whreclase + " order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
