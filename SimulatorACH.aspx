<%@ Page Title="" Language="C#" MasterPageFile="~/INCENTIMasterPage.master" AutoEventWireup="true" CodeFile="SimulatorACH.aspx.cs" Inherits="SimulatorACH" %>
...
<asp:HiddenField ID="Hidnfldname" runat="server" />
  ...
  <td class="style10"> 
      <div id="Div1" 
                  style="width: 100%; text-align:left;"> <left><asp:Label ID="Label90"  Font-Size="Medium" Font-Bold="true" Font-Names="calibri" runat="server"></asp:Label></left> 
...
<th class="style8" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);background-color:#0d9dbc;color:White; font-style:normal; border-radius: 10px"> CHANGE ACH </th>
   ...
   <td class="style8"> <center> <asp:TextBox ID="editableTextBox" runat="server" Height="100%" Font-Bold="true" BorderStyle="dotted" Text="Insert your Achievement" width="95%" CssClass="style5" AutoPostBack="true"  Font-Names="calibri" OnTextChanged="editableTextBox_TextChanged"></asp:TextBox></center></td>     
  ...
  <td class="style8"> <center> <asp:TextBox ID="TextBox1" runat="server" Height="100%" Font-Bold="true" width="95%" BorderStyle="dotted" Text="Insert your Achievement" CssClass="style5" AutoPostBack="true" Font-Names="calibri" OnTextChanged="editableTextBox_TextChanged"></asp:TextBox></center></td>     
   ...
   <td class="style8"> <center> <asp:TextBox ID="TextBox2" runat="server" Height="100%" Font-Bold="true" width="95%" BorderStyle="dotted" Text="Insert your Achievement" CssClass="style5" AutoPostBack="true" Font-Names="calibri" OnTextChanged="editableTextBox_TextChanged"></asp:TextBox></center></td>     
 ...
 <td class="style8"> <center> <asp:TextBox ID="TextBox3" runat="server" Height="100%" Font-Bold="true" width="95%" BorderStyle="dotted" Text="Insert your Achievement" CssClass="style5" AutoPostBack="true" Font-Names="calibri" OnTextChanged="editableTextBox_TextChanged"></asp:TextBox></center></td>     
   ...
   <td class="style8"> <center> <asp:TextBox ID="TextBox4" runat="server" Height="100%" Font-Bold="true" width="95%" BorderStyle="dotted" Text="Insert your Achievement"  CssClass="style5" AutoPostBack="true" Font-Names="calibri" OnTextChanged="editableTextBox_TextChanged"></asp:TextBox></center></td>     
   <td class="style8"><center> <asp:Label ID="Label30" CssClass="style5" Height="100%" Font-Bold="true" ToolTip="KPI 2 Incentive" Text="KPI 2 Ach%" Font-Names="calibri" runat="server"></asp:Label> </center></td> </tr>
    ...
    <%----Consitency ----%>
   <tr>  
   <td class="style8"> <center><asp:Label ID="Label31" CssClass="style5" Height="100%" Font-Bold="True" Text="CONSISTENCY Q1" Font-Names="calibri" runat="server" Width="272px"></asp:Label> </center></td> 
   ...
   <td class="style8"> <center> <asp:TextBox ID="TextBox5" runat="server" Height="100%" Enabled="false" Font-Bold="true" width="95%" BorderStyle="None" CssClass="style5" AutoPostBack="true" Font-Names="calibri" OnTextChanged="editableTextBox_TextChanged"></asp:TextBox></center></td>     
   <td class="style8"><center> <asp:Label ID="Label35" CssClass="style5" Height="100%" Font-Bold="true" ToolTip="Consistency Qtr 1" Text="Consistency Ach%" Font-Names="calibri" runat="server"></asp:Label> </center></td> </tr>
   ...
   <td class="style8"> <center><asp:Label ID="Label81" CssClass="style5" Height="100%" Font-Bold="true"  Font-Names="calibri" runat="server"></asp:Label></center></td> 
...
<%--     <hr />
   ...
   <td class="style8" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);background-color:White;color:Black; font-style:normal; border-radius: 10px"><center> <asp:Label ID="Label65" CssClass="style5" Height="100%" Font-Bold="true" ToolTip="Pro Rata Factor"  Font-Names="calibri" runat="server"></asp:Label> </center></td> </tr>
   </table>
     <hr />
<%--<table>
   <tr><td colspan="5" class="style8" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.5); background-color:#0d9dbc; color:White; font-style:normal; border-radius: 10px" > 
   <center><asp:Label ID="Label69" CssClass="style5" Height="100%" Font-Bold="True" 
           Text="ELIGIBILITY" Font-Names="calibri" runat="server" Width="1500px"></asp:Label> </center> </td> 
  </tr> </table>  <hr />--%>
  ...
  <%----CallAvg ----%>
   ...
   <td class="style8"> <center><asp:Label ID="Label70" CssClass="style5" Height="100%"  Font-Bold="true" ToolTip="Call Avg" Text="-" Font-Names="calibri" runat="server"></asp:Label></center> </td> 
   ...
   <td class="style8" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);background-color:White;color:Black; font-style:normal; border-radius: 10px"><center> <asp:Label ID="Label80" CssClass="style5" Height="100%" Font-Bold="true" ToolTip="Total Amonut" Text="Consistency Ach%" Font-Names="calibri" runat="server"></asp:Label> </center></td> </tr>
