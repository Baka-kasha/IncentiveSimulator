...
public partial class Consistency : System.Web.UI.Page
{
    ...
    public void BindGrid()
    {
        ...
        if (sm == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT B.*,A.Consistency_Q1,A.Consistency_Q2,A.Consistency_Q3,A.Consistency_Q4 FROM [dbo].[EMPLOYEE_Incentive_Consistency_TAB] A inner join [EMPLOYEE_Incentive_TAB] B ON A.FS_CODE=B.FS_CODE where A.SM='" + Session["FSCODE"] + "' order by A.ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
        ...
        if (rbm == desgna || (rm == desgna && tea == "GT+MT") || (zbm == desgna && tea == "AX"))
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT B.*,A.Consistency_Q1,A.Consistency_Q2,A.Consistency_Q3,A.Consistency_Q4 FROM [dbo].[EMPLOYEE_Incentive_Consistency_TAB] A inner join [EMPLOYEE_Incentive_TAB] B ON A.FS_CODE=B.FS_CODE where A.RBM='" + Session["FSCODE"] + "' order by A.ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (dsm == desgna || asm == desgna || (rm == desgna && tea == "AX") || nkam == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT B.*,A.Consistency_Q1,A.Consistency_Q2,A.Consistency_Q3,A.Consistency_Q4 FROM [dbo].[EMPLOYEE_Incentive_Consistency_TAB] A inner join [EMPLOYEE_Incentive_TAB] B ON A.FS_CODE=B.FS_CODE where A.DSM='" + Session["FSCODE"] + "' order by A.ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (tbe == desgna || tbm == desgna || tso == desgna || kam == desgna || kae == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT B.*,A.Consistency_Q1,A.Consistency_Q2,A.Consistency_Q3,A.Consistency_Q4 FROM [dbo].[EMPLOYEE_Incentive_Consistency_TAB] A inner join [EMPLOYEE_Incentive_TAB] B ON A.FS_CODE=B.FS_CODE where A.FS_Code ='" + Session["FSCODE"] + "'order by A.ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (desgna == "Admin")
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT B.*,A.Consistency_Q1,A.Consistency_Q2,A.Consistency_Q3,A.Consistency_Q4 FROM [dbo].[EMPLOYEE_Incentive_Consistency_TAB] A inner join [EMPLOYEE_Incentive_TAB] B ON A.FS_CODE=B.FS_CODE order by A.ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
    ...
    private void ExportGridToExcel()
    {
        ...
        if (sm == desgna)
        {
            StrQrry = " select [DESIGNATION],[EMP_NAME],[CLIENT_HQ],[NOP_HQ],[Consistency_Q1],[Consistency_Q2],[Consistency_Q3],[Consistency_Q4] from [dbo].[EMPLOYEE_Incentive_Consistency_TAB] where SM ='" + Session["FSCODE"] + "' order by ROW_ID;";

        }
        if (rbm == desgna || (rm == desgna && tea == "CX") )
        {
            StrQrry = " select [DESIGNATION],[EMP_NAME],[CLIENT_HQ],[NOP_HQ],[Consistency_Q1],[Consistency_Q2],[Consistency_Q3],[Consistency_Q4] from [dbo].[EMPLOYEE_Incentive_Consistency_TAB] where RBM ='" + Session["FSCODE"] + "' order by ROW_ID;";

        }
        if (dsm == desgna || asm == desgna || (rm == desgna && tea == "AX") || nkam == desgna)
        {
            StrQrry = " select [DESIGNATION],[EMP_NAME],[CLIENT_HQ],[NOP_HQ],[Consistency_Q1],[Consistency_Q2],[Consistency_Q3],[Consistency_Q4] from [dbo].[EMPLOYEE_Incentive_Consistency_TAB] where DSM ='" + Session["FSCODE"] + "' order by ROW_ID;";

        }
        if (tbe == desgna || tbm == desgna || tso == desgna || kam == desgna || kae == desgna)
        {
            StrQrry = " select [DESIGNATION],[EMP_NAME],[CLIENT_HQ],[NOP_HQ],[Consistency_Q1],[Consistency_Q2],[Consistency_Q3],[Consistency_Q4] from [dbo].[EMPLOYEE_Incentive_Consistency_TAB] where FS_Code ='" + Session["FSCODE"] + "' order by ROW_ID;";

        }
        if (desgna == "Admin")
        {
            StrQrry = " select [DESIGNATION],[EMP_NAME],[CLIENT_HQ],[NOP_HQ],[Consistency_Q1],[Consistency_Q2],[Consistency_Q3],[Consistency_Q4] from [dbo].[EMPLOYEE_Incentive_Consistency_TAB] order by ROW_ID;";
        ...
        Response.Charset = "";
        string FileName = "CONSISTENCY " + Session["FSCODE"] + "_" + DateTime.Now + ".xls";
    ...
    protected void Organo_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                string CONSIST = e.Row.Cells[12].Text;
                if (CONSIST == "PASS")
                {
                    SqlCommand cmd = new SqlCommand("SELECT * FROM [dbo].[Consistency$] where DESIGNATION = '" + Designation + "' and Qtr = '" + Qtr + "' ;", conn);
                    conn.Open();
                    ...
                    string AMOUNT = logintbl.Rows[0][3].ToString();
                    //AMOUNT = AMOUNT.Replace("1", "PASS");
                    ...
                    if (decimal.TryParse(logintbl.Rows[0][2].ToString(), out dataTableValue))
                    {
                        // Comparison
                        if (ACHIVEVEEMNT >= dataTableValue)
                        {
                            ...
                            SqlCommand cmmd = new SqlCommand("[EMPLOYEE_Incentive_Consistency]", conn);
                            {

                                string FSCODE = e.Row.Cells[5].Text;
                                cmmd.CommandType = CommandType.StoredProcedure;
                                cmmd.Parameters.AddWithValue("@Consistency_Q1", INCENTSP.ToString());
                        ...
                        {
                            // Your code here if ACH is less than the value in the DataTable
                        }
                    }
                    else
                    {
    ...
    protected void refersh_Click(object sender, EventArgs e)
    {
        ...
        if (sm == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT B.*,A.Consistency_Q1,A.Consistency_Q2,A.Consistency_Q3,A.Consistency_Q4 FROM [dbo].[EMPLOYEE_Incentive_Consistency_TAB] A inner join [EMPLOYEE_Incentive_TAB] B ON A.FS_CODE=B.FS_CODE where A.SM='" + Session["FSCODE"] + "' " + whreclase + " order by A.ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (rbm == desgna || (rm == desgna && tea == "CX") )
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT B.*,A.Consistency_Q1,A.Consistency_Q2,A.Consistency_Q3,A.Consistency_Q4 FROM [dbo].[EMPLOYEE_Incentive_Consistency_TAB] A inner join [EMPLOYEE_Incentive_TAB] B ON A.FS_CODE=B.FS_CODE where A.RBM='" + Session["FSCODE"] + "'  " + whreclase + " order by A.ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (dsm == desgna || asm == desgna || (rm == desgna && tea == "AX") || nkam == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT B.*,A.Consistency_Q1,A.Consistency_Q2,A.Consistency_Q3,A.Consistency_Q4 FROM [dbo].[EMPLOYEE_Incentive_Consistency_TAB] A inner join [EMPLOYEE_Incentive_TAB] B ON A.FS_CODE=B.FS_CODE where A.DSM='" + Session["FSCODE"] + "'  " + whreclase + " order by A.ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (desgna == "Admin")
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT B.*,A.Consistency_Q1,A.Consistency_Q2,A.Consistency_Q3,A.Consistency_Q4 FROM [dbo].[EMPLOYEE_Incentive_Consistency_TAB] A inner join [EMPLOYEE_Incentive_TAB] B ON A.FS_CODE=B.FS_CODE where " + whreclase + " order by A.ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
