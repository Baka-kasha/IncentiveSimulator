<%@ Page Title="" Language="C#" MasterPageFile="~/INCENTIMasterPage.master" AutoEventWireup="true" CodeFile="EXCEPTIONS.aspx.cs" Inherits="EXCEPTIONS" %>
...
<asp:HiddenField ID="Hidnfldname" runat="server" />
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>   
   ...
   </div> <td><center> <asp:Label ID="Label7" Font-Size="X-Large" ForeColor="White" Font-Bold="true" Font-Names="calibri" runat="server">____</asp:Label>  <asp:Label ID="Label5" Font-Size="X-Large"  ForeColor="White" Font-Bold="true" Font-Names="calibri" runat="server">QUALIFIER</asp:Label></center></td>
     </table>   
...
<div>  
   ...
   <asp:Label ID="Label4" Font-Size="Large" CssClass="centerforlab" Font-Bold="true" Font-Names="calibri" runat="server">[EXCEPTIONS]</asp:Label>
   <hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
...
<hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
  ...
  <asp:BoundField DataField="NOP_HQ" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="NOP"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />      
                    <asp:BoundField DataField="ELIGIBLE" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="ELIGIBLE"   ItemStyle-Width="200px"  HeaderStyle-Width="200px" /> 
                              <asp:BoundField DataField="REMARKS" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="REMARKS"  ItemStyle-Width="1000px"  HeaderStyle-Width="1000px" />    
