<%@ Page Title="" Language="C#" MasterPageFile="~/INCENTIMasterPage.master" AutoEventWireup="true" CodeFile="PCPM.aspx.cs" Inherits="PCPM" %>
...
<asp:HiddenField ID="Hidnfldname" runat="server" />
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>   
   ...
   </div> <td><center>  <asp:Label ID="Label5" Font-Size="X-Large" Font-Bold="true" Font-Names="calibri" runat="server">PRODUCTIVITY</asp:Label></center></td>
     </table>   
...
<div>  
 ...
 <center> <asp:Label ID="Label7" Font-Size="Large" ForeColor="White" Font-Bold="true" Font-Names="calibri" runat="server">____</asp:Label> <asp:Label ID="Label4" Font-Size="Large" Font-Bold="true" Font-Names="calibri" runat="server">[PCPM]</asp:Label></center> 
   <hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
<hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
  ...
  <asp:BoundField DataField="NOP_HQ" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="NOP"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />      
                    <asp:BoundField DataField="PCPM" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="PCPM"   ItemStyle-Width="200px"  HeaderStyle-Width="200px" /> 
                           <asp:TemplateField HeaderText="POWER" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-Width="200px" >
        <ItemTemplate >
       
             <asp:Label ID="PCPM1" Font-Size="Small" Font-Bold="true" runat="server"></asp:Label>
        </ItemTemplate>
    </asp:TemplateField>
       <asp:TemplateField HeaderText="LEVEL" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-Width="200px" >
        <ItemTemplate >
       
             <asp:Label ID="LEVEL1" Font-Size="Small" Font-Bold="true" runat="server"></asp:Label>
        </ItemTemplate>
    </asp:TemplateField>
 </Columns>           
                  </asp:GridView>
