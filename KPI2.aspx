<%@ Page Title="" Language="C#" MasterPageFile="~/INCENTIMasterPage.master" AutoEventWireup="true" CodeFile="KPI2.aspx.cs" Inherits="KPI2" %>
...
<asp:HiddenField ID="Hidnfldname" runat="server" />
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>   
   ...
   </div> <td><center>  <asp:Label ID="Label5" Font-Size="X-Large" Font-Bold="true" Font-Names="calibri" runat="server">QUALITATIVE</asp:Label></center></td>
     </table>   
...
<div>  
 ...
 <center>   <asp:Label ID="Label7" Font-Size="Large" Font-Bold="true" ForeColor="White" Font-Names="calibri" runat="server">_________</asp:Label><asp:Label ID="Label4" Font-Size="Large"  Font-Bold="true" Font-Names="calibri" runat="server">[KPI 2]</asp:Label>
  </center> 
   <hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
...
<hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
  ...
  <asp:BoundField DataField="NOP_HQ" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="NOP"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />      
    <asp:BoundField DataField="E-CALL" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="QTR E-CALLS"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />      
  <asp:BoundField DataField="CME" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="QTR CME"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />      
 <asp:BoundField DataField="IQVIA" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="QTR IQVIA"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />      
  <asp:BoundField DataField="EXPIRY" Visible="false" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="QTR EXPIRY%"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />      
