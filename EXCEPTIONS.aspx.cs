...
public partial class EXCEPTIONS : System.Web.UI.Page
{
    ...
    public void BindGrid()
    {
        ...
        if (sm == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	SELECT [ROW_ID],[DIVISION],[TEAM],[DESIGNATION],[ZONE],[EMP_ID],[EMP_NAME],[HQ],[CLIENT_HQ],[NOP_HQ],ELIGIBLE,REMARKS,PAYOUT FROM [EMPLOYEE_Incentive_ELIGIBLE_TAB] where ELIGIBLE is not null and SM='" + Session["FSCODE"] + "' order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
        ...
        if (rbm == desgna || (rm == desgna && tea == "CX"))
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	SELECT [ROW_ID],[DIVISION],[TEAM],[DESIGNATION],[ZONE],[EMP_ID],[EMP_NAME],[HQ],[CLIENT_HQ],[NOP_HQ],ELIGIBLE,REMARKS,PAYOUT FROM [EMPLOYEE_Incentive_ELIGIBLE_TAB] where ELIGIBLE is not null and RBM='" + Session["FSCODE"] + "' order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (dsm == desgna || asm == desgna || (rm == desgna && tea == "AX") || nkam == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	SELECT [ROW_ID],[DIVISION],[TEAM],[DESIGNATION],[ZONE],[EMP_ID],[EMP_NAME],[HQ],[CLIENT_HQ],[NOP_HQ],ELIGIBLE,REMARKS,PAYOUT FROM [EMPLOYEE_Incentive_ELIGIBLE_TAB] where ELIGIBLE is not null and DSM='" + Session["FSCODE"] + "' order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (tbe == desgna || tbm == desgna || tso == desgna || kam == desgna || kae == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT * FROM [EMPLOYEE_Incentive_ELIGIBLE_TAB] where FS_Code ='" + Session["FSCODE"] + "'order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (desgna == "Admin")
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	  SELECT [ROW_ID],[DIVISION],[TEAM],[DESIGNATION],[ZONE],[EMP_ID],[EMP_NAME],[HQ],[CLIENT_HQ],[NOP_HQ],ELIGIBLE,REMARKS,PAYOUT FROM [EMPLOYEE_Incentive_ELIGIBLE_TAB] where ELIGIBLE is not null ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
    ...
    private void ExportGridToExcel()
    {
        ...
        if (sm == desgna)
        {
            StrQrry = " SELECT  [DESIGNATION],[EMP_NAME],[CLIENT_HQ],[NOP_HQ],[TARGET_VAL],[PRIMARY_VAL],[ACH][ACH%] FROM [EMPLOYEE_Incentive_ELIGIBLE_TAB] where SM ='" + Session["FSCODE"] + "' order by ROW_ID;";

        }
        if (rbm == desgna || (rm == desgna && tea == "CX"))
        {
            StrQrry = " SELECT  [DESIGNATION],[EMP_NAME],[CLIENT_HQ],[NOP_HQ],[TARGET_VAL],[PRIMARY_VAL],[ACH][ACH%]  FROM [EMPLOYEE_Incentive_ELIGIBLE_TAB] where RBM ='" + Session["FSCODE"] + "' order by ROW_ID;";

        }
        if (dsm == desgna || asm == desgna || (rm == desgna && tea == "AX") || nkam == desgna)
        {
            StrQrry = " SELECT  [DESIGNATION],[EMP_NAME],[CLIENT_HQ],[NOP_HQ],[TARGET_VAL],[PRIMARY_VAL],[ACH][ACH%]  FROM [EMPLOYEE_Incentive_ELIGIBLE_TAB] where DSM ='" + Session["FSCODE"] + "' order by ROW_ID;";

        }
        if  (tbe == desgna || tbm == desgna || tso == desgna || kam == desgna || kae == desgna)
        {
            StrQrry = " SELECT  [DESIGNATION],[EMP_NAME],[CLIENT_HQ],[NOP_HQ],[TARGET_VAL],[PRIMARY_VAL],[ACH][ACH%] FROM [EMPLOYEE_Incentive_ELIGIBLE_TAB] where FS_Code ='" + Session["FSCODE"] + "' order by ROW_ID;";

        }
        if (desgna == "Admin")
        {
            StrQrry = " SELECT  [DESIGNATION],[EMP_NAME],[CLIENT_HQ],[NOP_HQ],[TARGET_VAL],[PRIMARY_VAL],[ACH][ACH%] FROM [EMPLOYEE_Incentive_ELIGIBLE_TAB] order by ROW_ID;";
    ...
    protected void refersh_Click(object sender, EventArgs e)
    {
        ...
        if (sm == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT * FROM [EMPLOYEE_Incentive_ELIGIBLE_TAB] where SM='" + Session["FSCODE"] + "' " + whreclase + " and ELIGIBLE is not null order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (rbm == desgna || (rm == desgna && tea == "CX"))
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT [ROW_ID],[DIVISION],[TEAM],[DESIGNATION],[ZONE],[EMP_ID],[EMP_NAME],[HQ],[CLIENT_HQ],[NOP_HQ],ELIGIBLE,REMARKS,PAYOUT FROM [EMPLOYEE_Incentive_ELIGIBLE_TAB] where RBM='" + Session["FSCODE"] + "'  " + whreclase + " and ELIGIBLE is not null order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (dsm == desgna || asm == desgna || (rm == desgna && tea == "AX") || nkam == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT [ROW_ID],[DIVISION],[TEAM],[DESIGNATION],[ZONE],[EMP_ID],[EMP_NAME],[HQ],[CLIENT_HQ],[NOP_HQ],ELIGIBLE,REMARKS,PAYOUT FROM [EMPLOYEE_Incentive_ELIGIBLE_TAB] where DSM='" + Session["FSCODE"] + "' " + whreclase + " and ELIGIBLE is not null order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if  (tbe == desgna || tbm == desgna || tso == desgna || kam == desgna || kae == desgna)
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT [ROW_ID],[DIVISION],[TEAM],[DESIGNATION],[ZONE],[EMP_ID],[EMP_NAME],[HQ],[CLIENT_HQ],[NOP_HQ],ELIGIBLE,REMARKS,PAYOUT FROM [EMPLOYEE_Incentive_ELIGIBLE_TAB] where FS_Code ='" + Session["FSCODE"] + "  'order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
        ...
        if (desgna == "Admin")
        {
            ...
            string StrQrry = "";
            StrQrry = "";
            StrQrry = "	 SELECT [ROW_ID],[DIVISION],[TEAM],[DESIGNATION],[ZONE],[EMP_ID],[EMP_NAME],[HQ],[CLIENT_HQ],[NOP_HQ],ELIGIBLE,REMARKS,PAYOUT FROM [EMPLOYEE_Incentive_ELIGIBLE_TAB] where " + whreclase + " and ELIGIBLE is not null order by ROW_ID ";
            string conn = ConfigurationManager.ConnectionStrings["sqlcon"].ConnectionString;
            SqlDataAdapter adpRpt = new SqlDataAdapter(StrQrry, conn);
            adpRpt.Fill(DsStockist, "DsStockist");
            adpRpt.Fill(dtDsStockist);
