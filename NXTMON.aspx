<%@ Page Title="" Language="C#" MasterPageFile="~/INCENTIMasterPage.master" AutoEventWireup="true" CodeFile="NXTMON.aspx.cs" Inherits="NXTMON" %>
...
<div>  
   ...
   <center><asp:Label ID="Label7" Font-Size="Large" ForeColor="White" Font-Bold="true" Font-Names="calibri" runat="server">_____</asp:Label><asp:Label ID="Label4" Font-Size="Large"  Font-Bold="true" Font-Names="calibri" runat="server">[NEXT MONTH ACH]</asp:Label></center>
   <hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
...
<hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
  ...
  <asp:BoundField DataField="NOP_HQ" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="NOP"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />      
                    <asp:BoundField DataField="NXTMON_TGT" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="TARGET"   ItemStyle-Width="200px"  HeaderStyle-Width="200px" /> 
                              <asp:BoundField DataField="NXTMON_VAL" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="VALUE"  ItemStyle-Width="200px"  HeaderStyle-Width="200px" />    
                           <asp:BoundField DataField="NXTMON_Pr" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="ACH%"  ItemStyle-Width="200px"  HeaderStyle-Width="200px" />    
