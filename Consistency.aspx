<%@ Page Title="" Language="C#" MasterPageFile="~/INCENTIMasterPage.master" AutoEventWireup="true" CodeFile="Consistency.aspx.cs" Inherits="Consistency" %>
...
<asp:HiddenField ID="Hidnfldname" runat="server" />
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>   
   ...
   </div> <td><center>  <asp:Label ID="Label5" Font-Size="X-Large" Font-Bold="true" Font-Names="calibri" runat="server">CONSISTENCY</asp:Label></center></td>
     </table>   
...
<div>  
   ...
   <asp:Label ID="Label4" Font-Size="Large" CssClass="centerforlab" Font-Bold="true" Font-Names="calibri" runat="server">[Q1 CONSISTENCY ACHIEVEMENT]</asp:Label>
   <hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
...
<hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
  ...
  <asp:BoundField DataField="NOP_HQ" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="NOP"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />      
                    <asp:BoundField DataField="TARGET_VAL" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="QTR TGT"   ItemStyle-Width="200px"  HeaderStyle-Width="200px" /> 
                              <asp:BoundField DataField="PRIMARY_VAL" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="QTR VAL"  ItemStyle-Width="200px"  HeaderStyle-Width="200px" />    
    ...
    <asp:BoundField DataField="Consistency_Q1" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="QTR 1 CONSISTENCY"  ItemStyle-Width="200px"  HeaderStyle-Width="200px" />    
