<%@ Page Title="" Language="C#" MasterPageFile="~/INCENTIMasterPage.master" AutoEventWireup="true" CodeFile="Proratafactor.aspx.cs" Inherits="Proratafactor" %>
...
<asp:HiddenField ID="Hidnfldname" runat="server" />
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>   
   ...
   </div> <td><center>  <asp:Label ID="Label5" Font-Size="X-Large" Font-Bold="true" Font-Names="calibri" runat="server">PRO RATA FACTOR</asp:Label></center></td>
     </table>   
...
<center>  <asp:Label ID="Label7" Font-Size="Large" Font-Bold="true" ForeColor="white" Font-Names="calibri" runat="server">_______</asp:Label><asp:Label ID="Label4" Font-Size="Large" Font-Bold="true" Font-Names="calibri" runat="server">[DAYS IN QTR]</asp:Label></center> 
   <hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
...
<hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
    ...
    <asp:GridView ID="Organo" HeaderStyle-BackColor="#0d9dbc"
        ...
        ShowHeader="true" ShowHeaderWhenEmpty="true"
           ...
           <asp:BoundField DataField="ROW_ID" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="left"  HeaderStyle-HorizontalAlign="Left" HeaderText="ROW_ID" Visible="false" ItemStyle-Width="100px"  HeaderStyle-Width="100px" />
                          <asp:BoundField DataField="BU" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="left" HeaderText="DIVISION" ItemStyle-Width="100px"   HeaderStyle-Width="100px" Visible="false" />
                           <asp:BoundField DataField="TEAM" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="left"  HeaderStyle-HorizontalAlign="Left" HeaderText="TEAM" ItemStyle-Width="50px" HeaderStyle-Width="50px" />
                                <asp:BoundField DataField="DESIGN" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="DESIGNATION" ItemStyle-Width="50px"   HeaderStyle-Width="50px" />
   <asp:BoundField DataField="ZONE" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="ZONE"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" Visible="false" /> 
       <asp:BoundField DataField="FS_CODE" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="FS_Code" ItemStyle-Width="200px"  HeaderStyle-Width="200px" /> 
                     <asp:BoundField DataField="NAME" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Left" HeaderText="NAME"  ItemStyle-Width="450px"  HeaderStyle-Width="450px" /> 
  <asp:BoundField DataField="H#Q# (Empower)" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Left" HeaderText="HQ"  ItemStyle-Width="350px"  HeaderStyle-Width="350px" /> 
  <asp:BoundField DataField="NOP_GCV" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="NOP"  ItemStyle-Width="50px"  HeaderStyle-Width="50px" />      
     <asp:BoundField DataField="DOJ" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="DOJ"  ItemStyle-Width="200px"  HeaderStyle-Width="100px" />      
             <asp:TemplateField HeaderText="DAYS IN QTR" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" ItemStyle-Width="200px" HeaderStyle-Width="100px" >
        <ItemTemplate  >
       
             <asp:Label ID="DOJ_Qtr" runat="server"></asp:Label>
        </ItemTemplate>
    </asp:TemplateField>
