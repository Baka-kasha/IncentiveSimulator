<%@ Page Title="" Language="C#" MasterPageFile="~/INCENTIMasterPage.master" AutoEventWireup="true" CodeFile="Quailifiers.aspx.cs" Inherits="Quailifiers" %>
...
<asp:HiddenField ID="Hidnfldname" runat="server" />
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>   
   ...
   </div> <td><center>  <asp:Label ID="Label5" Font-Size="X-Large" Font-Bold="true" Font-Names="calibri" runat="server">OVERALL REPORT</asp:Label></center></td>
     </table>   
...
<div>  
   <hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
    <center><asp:Label ID="Label7" Font-Size="Large" Font-Bold="true" ForeColor="White" Font-Names="calibri" runat="server">______</asp:Label>  <asp:Label ID="Label4" Font-Size="Large" Font-Bold="true" Font-Names="calibri" runat="server">[PAYOUT AMOUNT]</asp:Label></center>
   <hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
...
<hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
    ...
    <asp:GridView ID="Organo" HeaderStyle-BackColor="#0d9dbc"
        ...
        ShowHeader="true" ShowHeaderWhenEmpty="true"
           ...
           <asp:BoundField DataField="ROW_ID" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="left"  HeaderStyle-HorizontalAlign="Left" HeaderText="ROW_ID" Visible="false" ItemStyle-Width="100px"  HeaderStyle-Width="100px" />
                          <asp:BoundField DataField="DIVISION" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="left" HeaderText="DIVISION" ItemStyle-Width="50px"   HeaderStyle-Width="50px"  />
                           <asp:BoundField DataField="TEAM" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="left"  HeaderStyle-HorizontalAlign="Left" HeaderText="TEAM" ItemStyle-Width="100px" HeaderStyle-Width="100px" />
                                <asp:BoundField DataField="DESIGNATION" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="DESIGNATION" ItemStyle-Width="20px"   HeaderStyle-Width="20px" />
   <asp:BoundField DataField="ZONE" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="ZONE"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" Visible="false" /> 
       <asp:BoundField DataField="FS_CODE" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="FS_Code" ItemStyle-Width="200px"  HeaderStyle-Width="200px" /> 
                     <asp:BoundField DataField="EMP_NAME" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Left" HeaderText="NAME"  ItemStyle-Width="200px"  HeaderStyle-Width="200px" /> 
  <asp:BoundField DataField="CLIENT_HQ" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Left" HeaderText="HQ"  ItemStyle-Width="250px"  HeaderStyle-Width="250px" /> 
  <asp:BoundField DataField="NOP_HQ" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="NOP"  ItemStyle-Width="50px"  HeaderStyle-Width="50px" />      
                     <asp:BoundField DataField="FINALAMT" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="TOTAL AMOUNT"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />    
                             <asp:BoundField DataField="OVERALL_ACH" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="OVERALL ACH%"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />    
  <asp:BoundField DataField="CALLAVG" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="CALL AVG% - FWD"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />    
                 <asp:BoundField DataField="SnBPr" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="SnB %"   ItemStyle-Width="100px"  HeaderStyle-Width="100px" /> 
                              <asp:BoundField DataField="PriSecPr" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="PRI vs SEC %"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />    
                    <asp:BoundField DataField="NXTMON_Pr" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="NXT MON ACH %"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />    
                  <asp:TemplateField HeaderText="FINAL PAYOUT" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-Width="100px" >
        <ItemTemplate >
       
             <asp:Label ID="Incent1" Font-Size="Small" Font-Bold="true" runat="server"></asp:Label>
        </ItemTemplate>
    </asp:TemplateField>
       <asp:TemplateField HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-Height="1px" ItemStyle-Width="100px" HeaderText="MANAGER APPROVAL">
                                       <ItemTemplate>  
                      <%--<center>  <asp:CheckBox ID="CheckBox1" ToolTip="Click to Unblock"  AutoPostBack="true" OnCheckedChanged="changed" runat="server" />  </center>--%>
                           <center> <asp:DropDownList ID="ddlapproval" AutoPostBack="true"   CssClass="ddl"  runat="server">
                 </asp:DropDownList> </center> 
                    </ItemTemplate>  
                </asp:TemplateField>  
                 <asp:TemplateField HeaderStyle-Width="100px" ItemStyle-Width="100px"  Visible="false" ItemStyle-Height="1px" HeaderStyle-HorizontalAlign="Center" HeaderText="AUDITOR CHECK"> 
                                       <ItemTemplate>  
                       <center> <asp:DropDownList ID="ddlaudit" CssClass="ddl"  runat="server">
                 </asp:DropDownList> </center> 
                    </ItemTemplate>  
                </asp:TemplateField>
                <asp:TemplateField HeaderStyle-Width="30px" ItemStyle-Width="100px" ItemStyle-Height="1px" HeaderStyle-HorizontalAlign="Center"  HeaderText="REMARKS"> 
                                       <ItemTemplate>  
                         <asp:TextBox ID="txtreason" CssClass="ddl" runat="server"></asp:TextBox> 
                    </ItemTemplate>  
                </asp:TemplateField>
                    <asp:BoundField DataField="PAYOUT" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="STATUS"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />    
                 <asp:BoundField DataField="ELIGIBLE" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="EXCEPTIONS"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />    

   
 </Columns>           
                  </asp:GridView>
                  <hr />
            <asp:Button ID="btnsubmit" CssClass="addbtn" OnClick="onclicksubmit"  runat="server" Text="SUBMIT" />  
</asp:Content>
