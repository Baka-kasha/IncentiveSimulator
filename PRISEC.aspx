<%@ Page Title="" Language="C#" MasterPageFile="~/INCENTIMasterPage.master" AutoEventWireup="true" CodeFile="PRISEC.aspx.cs" Inherits="PRISEC" %>
...
<asp:HiddenField ID="Hidnfldname" runat="server" />
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>   
   ...
   </div> <td><center>  <asp:Label ID="Label5" Font-Size="X-Large" Font-Bold="true" Font-Names="calibri" runat="server">QUALIFIER</asp:Label></center></td>
     </table>   
...
<div>  
 ...
 <center><asp:Label ID="Label7" Font-Size="Large"  Font-Bold="true" ForeColor="White" Font-Names="calibri" runat="server">________</asp:Label> <asp:Label ID="Label4" Font-Size="Large"  Font-Bold="true" Font-Names="calibri" runat="server">[PRI VS SEC]</asp:Label></center> 
   <hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
...
<hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
  ...
  <asp:BoundField DataField="NOP_HQ" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="NOP"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />      
                                  <asp:BoundField DataField="PRIMARY_VAL" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="QTR-PRIMARY"  ItemStyle-Width="200px"  HeaderStyle-Width="200px" />    
                         <asp:BoundField DataField="SECONDARY_VAL" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="QTR-SECONDARY"   ItemStyle-Width="200px"  HeaderStyle-Width="200px" /> 
                  <asp:BoundField DataField="PriSecPr" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="QTR-ACH%"  ItemStyle-Width="200px"  HeaderStyle-Width="200px" />    
