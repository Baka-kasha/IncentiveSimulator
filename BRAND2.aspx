<%@ Page Title="" Language="C#" MasterPageFile="~/INCENTIMasterPage.master" AutoEventWireup="true" CodeFile="BRAND2.aspx.cs" Inherits="BRAND2" %>
...
<div>  
 ...
 <center>    <asp:Label ID="Label8" Font-Size="Large"  ForeColor="White" Font-Bold="true" Font-Names="calibri" runat="server">_________</asp:Label><asp:Label ID="Label4" Font-Size="Large" Font-Bold="true" Font-Names="calibri" runat="server">[BRAND 2: </asp:Label><asp:Label ID="Label7" Font-Size="Large" Font-Bold="true" Font-Names="calibri" runat="server"></asp:Label></center>
   <hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
