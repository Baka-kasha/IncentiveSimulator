<%@ Page Title="" Language="C#" MasterPageFile="~/INCENTIMasterPage.master" AutoEventWireup="true" CodeFile="KPI1.aspx.cs" Inherits="KPI1" %>
...
<center>   <asp:Label ID="Label7" Font-Size="Large" Font-Bold="true" ForeColor="White" Font-Names="calibri" runat="server">_________</asp:Label><asp:Label ID="Label4" Font-Size="Large"  Font-Bold="true" Font-Names="calibri" runat="server">[KPI 1]</asp:Label>
...
<hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
  ...
  <asp:BoundField DataField="NOP_HQ" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="NOP"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />      
    <asp:BoundField DataField="Q1 VF%" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="QTR VF%"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />      
  <asp:BoundField DataField="Q1 NPD%" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="QTR NPD%"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />      
  <asp:BoundField DataField="Q1 Expiry%" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="QTR PHARMACY%"  ItemStyle-Width="100px"  HeaderStyle-Width="100px"  />      
