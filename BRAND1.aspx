<%@ Page Title="" Language="C#" MasterPageFile="~/INCENTIMasterPage.master" AutoEventWireup="true" CodeFile="BRAND1.aspx.cs" Inherits="BRAND1" %>
...
<asp:HiddenField ID="Hidnfldname" runat="server" />
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>   
   ...
   </div> <td><center>  <asp:Label ID="Label5" Font-Size="X-Large" Font-Bold="true" Font-Names="calibri" runat="server">QUANTITATIVE</asp:Label></center></td>
     </table>   
...
<center><asp:Label ID="Label8" Font-Size="Large"  ForeColor="White" Font-Bold="true" Font-Names="calibri" runat="server">______</asp:Label><asp:Label ID="Label4" Font-Size="Large" Font-Bold="true" Font-Names="calibri" runat="server">[BRAND 1: </asp:Label><asp:Label ID="Label7" Font-Size="Large" Font-Bold="true" Font-Names="calibri" runat="server"></asp:Label>
  </center><hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
...
<hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
  ...
  <asp:BoundField DataField="NOP_HQ" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="NOP"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />      
                    <asp:BoundField DataField="TARGET_VAL" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="TARGET"   ItemStyle-Width="200px"  HeaderStyle-Width="200px" /> 
                              <asp:BoundField DataField="PRIMARY_VAL" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="PRIMARY"  ItemStyle-Width="200px"  HeaderStyle-Width="200px" />    
                           <asp:BoundField DataField="ACH" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="ACH%"  ItemStyle-Width="200px"  HeaderStyle-Width="200px" />    
  <asp:TemplateField HeaderText="AMOUNT" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-Width="200px" >
        <ItemTemplate >
