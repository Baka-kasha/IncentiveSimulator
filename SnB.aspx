<%@ Page Title="" Language="C#" MasterPageFile="~/INCENTIMasterPage.master" AutoEventWireup="true" CodeFile="SnB.aspx.cs" Inherits="SnB" %>
...
<div>  
   ...
   <center><asp:Label ID="Label7" Font-Size="Large"  Font-Bold="true" ForeColor="White" Font-Names="calibri" runat="server">________</asp:Label><asp:Label ID="Label4" Font-Size="Large"  Font-Bold="true" Font-Names="calibri" runat="server">[SnB]</asp:Label></center>
   <hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
...
<hr style="width: 100%; box-shadow:0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-top: 8px; margin-left: 0px;" />
  ...
  <asp:BoundField DataField="NOP_HQ" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="NOP"  ItemStyle-Width="100px"  HeaderStyle-Width="100px" />      
                    <asp:BoundField DataField="SnB" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="SnB"   ItemStyle-Width="200px"  HeaderStyle-Width="200px" /> 
                                  <asp:BoundField DataField="SnBPr" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderText="SnB %"  ItemStyle-Width="200px"  HeaderStyle-Width="200px" />    
